      ...
      <section className="py-16 px-4 border-b border-theme-primary">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { num: "1", title: "Connect Your Store", desc: "Link your Shopify or WooCommerce store. We automatically import your sales data." },
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              { icon: <Link2 className={ICON_CLASS} />, title: "Store Integrations", desc: "Connect Shopify or WooCommerce. More platforms coming soon.", comingSoon: false },
