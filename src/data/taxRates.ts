...
// - Sales Tax Institute
//
// Last Updated: April 2026 (data as of January 1, 2026)
...
export const taxRateMetadata = {
  ...
  nextScheduledUpdate: "2026-07-01",
  sources: [
...
export const stateTaxRates: TaxRate[] = [
  ...
  { state: "Arkansas", stateCode: "AR", stateRate: 6.50, avgLocalRate: 2.96, combinedRate: 9.46, hasLocalTax: true },
  ...
  { state: "Louisiana", stateCode: "LA", stateRate: 5.00, avgLocalRate: 5.11, combinedRate: 10.11, hasLocalTax: true },
  ...
  { state: "Washington", stateCode: "WA", stateRate: 6.50, avgLocalRate: 3.01, combinedRate: 9.51, hasLocalTax: true },
