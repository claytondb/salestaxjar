...
2. Navigate to **Settings** > **eCommerce Settings** > **Tax**
...
1. In your **Wix Dashboard**, go to **Settings** > **Tax**
2. Under **Tax regions**, add each state where you have nexus
3. For each state, you can use automatic rates or set custom rates
4. Save your changes
...
1. Edit a product in your Wix store
2. Scroll to the **Tax Group** setting
3. Assign the appropriate group
...
1. **Track thresholds**: Monitor sales by state; register before hitting nexus thresholds
