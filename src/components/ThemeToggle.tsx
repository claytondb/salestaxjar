...
export default function ThemeToggle() {
  const [isDark, setIsDark] = useState(true); // Default to dark (current theme)
  ...
  return (
    <button
      onClick={toggleTheme}
      className="p-2 rounded-lg bg-white/10 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 transition"
